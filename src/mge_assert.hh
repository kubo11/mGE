...
namespace mge {
void vlog(const char* condition, const char* file, int line,
...
template <typename... T>
void log(const char* condition, const char* file, int line,
...
#define MGE_ASSERT(...)                                           \
  MGE_ASSERT_HELPER(, ##__VA_ARGS__, MGE_ASSERT_FMT(__VA_ARGS__), \
                    MGE_ASSERT_MSG(__VA_ARGS__),                  \
