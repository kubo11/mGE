...
struct RenderableComponent {
  RenderableComponent(std::shared_ptr<Shader> shader, std::unique_ptr<VertexArray> vertex_array = nullptr,
  ...
  inline VertexArray& get_vertex_array() const { return *m_vertex_array; }
